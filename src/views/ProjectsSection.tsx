					...
					<div className="lg:pr-8 lg:pt-4">
						<div className="lg:max-w-lg">
							...
							<p className="mt-6 text-lg leading-8 text-gray-600">
								Projeto do zero fornecido apenas o terreno e grade para base estrutural. Design e Terreo Livre, Projeto do zero fornecido apenas o terreno e grade para base estrutural. Design e Terreo Livre, Projeto do zero fornecido apenas o terreno e grade para base estrutural. Design e Terreo Livre
							</p>
